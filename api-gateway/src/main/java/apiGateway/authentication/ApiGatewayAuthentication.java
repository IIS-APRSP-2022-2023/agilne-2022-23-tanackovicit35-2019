...
public class ApiGatewayAuthentication {
	...
	public SecurityWebFilterChain filterChain(ServerHttpSecurity http) throws Exception{
		...
		.pathMatchers("/bank-account/postAccount").hasRole("ADMIN")
